...
- **Containers**: Provides a set of containers designed for environments where
  ...
  queue as well. `hxhash_table` and `hxrbtree` provide ordered and unordered
  sets and maps without requiring nodes to be subclasses or using copies and
